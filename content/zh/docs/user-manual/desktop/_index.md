...
![](media/desktop-login-3.png)

![](media/desktop-login-4.png)

4）MacOS版浏览器会提示您是否打开EachChat应用程序，这里选择"**打开EachChat"**。如下图所示：

![](media/desktop-login-5.png)

5）完成上述操作后，即可打开亿洽的操作主界面，如下图所示：

![](media/desktop-login-6.png)
...
![](media/desktop-chat-2.png)

2）选择列出里面你需要找的人，并发出邀请，等待对方接受邀请后，则可以正常聊天了，如下图所示：

![](media/desktop-chat-3.png)
